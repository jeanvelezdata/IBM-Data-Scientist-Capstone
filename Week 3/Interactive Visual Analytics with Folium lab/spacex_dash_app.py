...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values='class', 
                     names='Launch Site', 
                     title='Success rate for chosen site')
        return fig
...
def update_scatter_chart(entered_site, payload_range):
    ...
    fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class',  # Assuming you have a column named 'Launch Outcome'
                     title=f'Scatter chart for {entered_site}',
